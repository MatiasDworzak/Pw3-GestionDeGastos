...
namespace Validacion
{
   ...
   {
      public static void Registro(RegistroViewModel model)
      {
         ...
         ValidarStringRequerido(model.ConfirmarContrasenia, nameof(model.ConfirmarContrasenia));
      }
      public static void Login(CredencialViewModel model)
      {
